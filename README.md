...
Experienced Java and JavaScript/Node.js developer, now aspiring to work as a polyglot using AI-assisted development tools (GPT-5, Claude Sonnet 4.5, Cursor) to quickly adapt to new languages and frameworks. Skilled in REST API design, third-party integrations, webhooks, and microservices. Comfortable with automation platforms like Zapier, Make, and Retool. Backend experience includes Spring Boot, Hibernate, Express.js, and databases (MySQL, PostgreSQL, Redis). Familiar with AWS, CI/CD pipelines, Docker, and Agile/Scrum practices. Recently interested in prompt engineering and AI red teaming. 

---

## PROJECTS

### Umpire Buddy - Tennis Scoring App for Parents

**Personal Project** \| *React Native, Expo Go, TypeScript* \| *2024-2025*

- Created a tennis scoring app to help tennis parents keep track of their kids' matches without courtside confusion. Designed specifically for parents who shouldn't have to figure out tiebreak rules while cheering from the sidelines
- Prompted by me, code generated by Claude (React Native, Expo Go, TypeScript, and SQLite)
- Features intuitive scoring, live statistics, match history, and PNG export options.
- Launched on the Apple App Store (iOS): [Umpire Buddy](https://apps.apple.com/gb/app/umpire-buddy/id6746480566).
- Used Make.com scenarios to scrape emails from LTA pages for targeted email campaigns to promote the app via cold outreach.
- Recent performance: 2.76K impressions, 91 product page views, 1.24% conversion rate, 32 downloads.

---
### Brick Therapy — Instagram Content Automation (2000+ followers)

**Personal Project** \| *Make.com, OpenAI (GPT-4o, DALL·E 3), Google Sheets, Instagram API* \| *2024-2025*

- Automated content pipeline: pulls Pending rows from Google Sheets, generates captions with GPT-4o and multiple DALL·E 3 images, posts Instagram carousels with a CTA comment, and updates status with retry/error handling.
- Grew the account to 2,000+ followers (as of Oct 2025) via an automated Make.com content pipeline.
- Instagram: [@bricktherapybuilds](https://www.instagram.com/bricktherapybuilds/).

---

## PROFESSIONAL EXPERIENCE

### Career Break – Personal/Family Commitments
**August 2023 – Present**

Career break to focus on family while maintaining technical skills through certifications (AI Red Teaming, AI Agents) and exploring emerging technologies in AI and automation.
